...
The **Refresh pixel profile** workflow runs every 30 minutes and on manual dispatch. It uses the upstream MIT package `pixel-profile@1.3.0` to render the CRT-style statistics card from public GitHub data. The profile README intentionally does not include a project list or generated footer.
